...
config :raffley, RaffleyWeb.Endpoint,
  ...
  secret_key_base: "srHZNgPiua+A5C1RDZXMUtoh8JyWnWVlAD8m34sWqxeyjL2jhFKu4N9DdloREqGb",
  server: false
...
config :raffley, RaffleyWeb.Endpoint,
  http: [ip: {127, 0, 0, 1}, port: 4002],
  secret_key_base: "xxnKnV3M7bHoL5kjNee0ZoXERGxzqe+FX6bu70/NVI89A5PVJvxEbW/3oH484eoU",
  server: false
