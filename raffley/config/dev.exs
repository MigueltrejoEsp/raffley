...
config :raffley, RaffleyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "kBACLpz+2ehASBZHp2MWpWTM+2wSf2QTcDs8yOOisJBWhYM3AzHbCwl6YJLFUxqv",
  watchers: [
...
config :raffley, RaffleyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "3IVsfnIXOMJXqTXtsgp61WtSlW7Meu5a3O5j8fYR7w4nxdXxIg2L1U+T5kuCl/er",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:raffley, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:raffley, ~w(--watch)]}
  ]
